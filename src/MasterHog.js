    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor}  pigData={offspring[0]}/>
          <BabyHog eyeColor={this.state.eyeColor} pigData={offspring[1]}/>
          <BabyHog eyeColor={this.state.eyeColor} pigData={offspring[2]}/>
        </ul>
